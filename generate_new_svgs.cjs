...
const prohibidoMotosSvg = `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <circle cx="100" cy="100" r="90" fill="#FFFFFF" stroke="#D32F2F" stroke-width="20"/>
  <g transform="translate(0, 10)">
    <circle cx="60" cy="120" r="18" fill="#000000"/>
    <circle cx="140" cy="120" r="18" fill="#000000"/>
    <path d="M60 120 L90 120 L110 90 L130 90 L140 70 L130 70 L115 80 L90 80 L65 70 L80 100 L60 120 Z" fill="#000000"/>
    <path d="M80 80 Q100 60 120 80 H140 V90 H120 L110 100 H80 V80 Z" fill="#000000"/>
    <circle cx="140" cy="70" r="4" fill="#000000"/>
  </g>
  <path d="M35 35 L165 165" stroke="#D32F2F" stroke-width="18" stroke-linecap="round"/>
</svg>`;
...
const output =
  ...
  `PROHIBIDO_MOTOS=${toBase64(prohibidoMotosSvg)}`;
