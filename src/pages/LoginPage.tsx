    ...
    return (
        <div className="min-h-screen bg-brand-navy flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-2xl relative z-10">
                {/* Logo and Institution Text */}
                <div className="flex flex-col items-center mb-10">
                    <span className="text-brand-yellow font-brand-heading font-bold uppercase tracking-[0.2em] text-[10px] md:text-xs mb-4 block opacity-80">
