                    ...
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full">
                            ...
                            <div className="text-center md:text-left md:border-r md:border-gray-800 md:pr-12">
                                <img src={logoBA} alt="Buenos Aires Ciudad" className="h-14 md:h-20 w-auto drop-shadow-[0_0_8px_rgba(255,214,0,0.2)]" />
                            </div>
                            
                            {/* Textos de la Gerencia y Dirección */}
                            <div className="text-center md:text-left">
                                <p className="font-brand-heading uppercase tracking-[0.2em] text-xs sm:text-sm md:text-lg text-gray-200 font-bold">
                                    GERENCIA DE EDUCACIÓN Y CONVIVENCIA VIAL
                                </p>
                                <p className="font-brand-heading uppercase tracking-[0.2em] text-[10px] sm:text-xs md:text-sm text-gray-500 mt-2">
